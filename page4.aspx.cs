...
namespace home
{
    public partial class page4 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (RadioButtonList1.SelectedItem.Text.Equals(".aspx"))

            {
                count = "4";

            }
            SqlCommand cmd = new SqlCommand("update quiz set q4 = @q4 where name=@name", con);
            con.Open();
            ...
            if (res > 0)
            {
                Response.Redirect("page5.aspx?name=" + name);
